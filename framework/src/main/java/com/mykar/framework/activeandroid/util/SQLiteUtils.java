package com.mykar.framework.activeandroid.util;
...
import com.mykar.framework.activeandroid.TableInfo;
import com.mykar.framework.activeandroid.annotation.Column;
import com.mykar.framework.activeandroid.annotation.Column.ConflictAction;
	...
	public static <T extends Model> List<T> processCursor(Class<? extends Model> type, Cursor cursor) {
		...
		try {
			...
			if (cursor.moveToFirst()) {
                /**
                 * Obtain the columns ordered to fix issue #106 (https://github.com/pardom/mykar.framework.activeandroid/issues/106)
			...
			throw new RuntimeException(
                ...
                "now in mykar.framework.activeandroid models, as the process to " +
