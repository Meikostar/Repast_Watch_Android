...
import com.mykar.framework.ui.view.horizontallistview.utils.ReflectionUtils;
import com.mykar.framework.ui.view.horizontallistview.utils.ReflectionUtils.ReflectionException;
import com.mykar.framework.ui.view.horizontallistview.widget.IFlingRunnable.FlingRunnableView;
...
public class HorizontalVariableListView extends HorizontalListView implements OnGestureListener, FlingRunnableView {
	...
	private synchronized void initView() {
		...
		if ( Build.VERSION.SDK_INT > 8 ) {
			try {
				mFlingRunnable = (IFlingRunnable) ReflectionUtils.newInstance( "com.mykar.framework.HorizontalVariableListView.widget.Fling9Runnable",
